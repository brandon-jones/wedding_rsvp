...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { attending: @rsvp.attending, contact: @rsvp.contact, name: @rsvp.name, party_size: @rsvp.party_size }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { attending: @rsvp.attending, contact: @rsvp.contact, name: @rsvp.name, party_size: @rsvp.party_size }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
